                                    ...
                                    <tr class="align-middle hover:bg-gray-50">
                                        ...
                                        <td class="px-4 sm:px-6 py-4 text-sm text-gray-700">
                                            ...
                                            @elseif ($user->access_level == 2)
                                                @if ($user->is_admin == 1)
                                                    <span class="px-2 py-1 inline-flex text-xs sm:text-sm font-semibold rounded-full bg-yellow-200 text-yellow-800">Super Admin</span>
                                                @else
    ...
    @else
        <div class="bg-white p-3 sm:p-4 rounded-lg shadow-md mb-4 sm:mb-6 mt-6 mx-4">
             <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    <input type="text" id="companySearchInput" placeholder="Search by company name" 
                           class="w-full sm:w-auto border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
