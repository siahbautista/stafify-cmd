            ...
            <div class="flex flex-col gap-4 w-full border border-zinc-200 p-5 rounded-[20px] bg-[#f8f9fa] lg:flex-row">
                ...
                <div class="flex flex-col gap-2 w-full py-3 px-5 bg-[#ffffff] rounded-[10px] border border-[#f1f1f1] edit-profile">
                    <div class="field-group">
                        ...
                        <input type="text" name="full_name" id="editFullName" class="w-full border p-2 rounded mb-2" required>
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Email</label>
                        <input type="email" name="user_email" id="editEmail" class="w-full border p-2 rounded mb-2" required>
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Phone Number</label>
                        <input type="text" name="phone_number" id="editPhone" class="w-full border p-2 rounded mb-2" required>
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" name="user_pin" id="editPin" class="w-full border p-2 rounded mb-2">
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4 w-full border border-zinc-200 p-5 rounded-[20px] bg-[#f8f9fa] lg:flex-row">
                ...
                <div class="flex flex-col gap-2 w-full py-3 px-5 bg-[#ffffff] rounded-[10px] border border-[#f1f1f1] edit-profile">
                    <div class="field-group">
                        ...
                        <input type="text" name="company" id="editCompany" class="w-full border p-2 rounded mb-2" required>
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Branch Location</label>
                        <input type="text" name="branch_location" id="editBranch" class="w-full border p-2 rounded mb-2">
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Department</label>
                        <input type="text" name="user_dept" id="editDept" class="w-full border p-2 rounded mb-2">
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Position</label>
                        <input type="text" name="user_position" id="editPosition" class="w-full border p-2 rounded mb-2">
                    </div>
                    <div class="field-group">
                        <label class="block mb-2">Starting Date</label>
                    ...
                    <div class="field-group">
                        ...
                        <select name="access_level" id="editAccessLevel" class="w-full border p-2 rounded mb-4" required>
