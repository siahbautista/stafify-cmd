...
@section('description', 'Manage legal compliance and regulatory requirements for your organization.')
...
<div class="px-0">
        ...
        <div class="mb-5 mt-2">
            <span class="eform-label">Select Legal Document</span>
        </div>
    ...
    <div class="mb-4">
        <div class="flex items-start gap-4 flex-wrap">
            ...
            @if($legal_toolkits->isEmpty())
                <!-- No Toolkits Message -->
                <div class="no-toolkits w-full text-center py-8">
                    <i class="fas fa-folder-open text-4xl text-gray-400 mb-3"></i>
                    <p class="text-gray-600">No legal documents available. Create your first legal document!</p>
                </div>
            @else
                <!-- Existing Toolkit Cards -->
                @foreach($legal_toolkits as $toolkit)
                    <div class="toolkit-card-wrapper flex flex-col items-center">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 border border-gray-100 relative">
        <div id="placeholderMessage" class="flex flex-col items-center justify-center h-[600px] text-gray-500">
            ...
            <span class="text-xl font-medium">Select a legal document to view its content</span>
            <p class="text-sm text-gray-400 mt-2">Click on any legal document card above to view its content here</p>
        </div>
        ...
        <div class="relative min-h-screen px-4 text-center">
            ...
            <div class="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl relative">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-medium text-gray-800">Add New Legal Document</h3>
                ...
                <form method="POST" action="{{ route('legal-toolkit.store') }}" class="mt-4">
                    @csrf
...
function loadToolkit(responseUrl, formUrl, isApproved, cardElement, toolkitTitle = '', type) {
    if (!isApproved) {
        Swal.fire({
            ...
            text: 'This legal document is currently pending administrator approval.',
            icon: 'warning',
            confirmButtonText: 'OK',
            confirmButtonColor: '#3B82F6'
        });
    ...
    if (embedUrl) {
        ...
        Swal.fire({
            ...
            text: 'This legal document does not have any content to display.',
            icon: 'info',
            confirmButtonText: 'OK',
            confirmButtonColor: '#3B82F6'
        });
...
function openAddToolkitModal(toolkit = null) {
    ...
    form.onsubmit = function(e) {
        ...
        if (!formData.get('toolkit_id')) {
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-left">
                        <p class="mb-4">Adding a new legal document will incur additional charges:</p>
    ...
    if (toolkit) {
        title.textContent = 'Edit Legal Document';
        ...
        title.textContent = 'Add New Legal Document';
        form.reset();
